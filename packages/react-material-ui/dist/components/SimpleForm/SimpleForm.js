...
const SimpleForm = (props) => {
    ...
    return (react_1.default.createElement(react_1.Fragment, null,
        ...
        react_1.default.createElement(Box_1.default, null,
            react_1.default.createElement(mui_1.default, { schema: schema, uiSchema: generateUiSchema(), formData: generateFormData(), noHtml5Validate: true, showErrorList: false, onError: onError, onSubmit: onSubmit, templates: { ArrayFieldTemplate: CustomWidgets_1.ArrayFieldTemplate }, customValidate: validate, validator: validator_ajv6_1.default },
                react_1.default.createElement(Button_1.default, { type: "submit", fullWidth: true, variant: "contained", sx: { mt: 3 } }, form.submitButtonLabel || 'Submit')))));
};
