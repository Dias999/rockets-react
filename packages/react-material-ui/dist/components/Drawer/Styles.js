...
exports.Drawer = (0, styles_1.styled)(Drawer_1.default)(({ theme, open }) => ({
    '& .MuiDrawer-paper': Object.assign({ backgroundColor: theme.palette.grey['800'], position: 'relative', whiteSpace: 'nowrap', width: 256, transition: theme.transitions.create('width', {
